...
public class DateTimeUtils {
    ...
    public static String parseDateTime(String dateString, String originalFormat, String outFormat) {
        ...
        try {
            ...
            SimpleDateFormat dateFormat = new SimpleDateFormat(outFormat, new Locale("US"));
